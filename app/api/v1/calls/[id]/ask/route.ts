...
export const POST = route(
  // Retrieval + generation + a REMi round trip is the most expensive operation in this API, so it
  // gets its own bucket at a quarter of the deployment's configured rate.
  { path: "/api/v1/calls/{id}/ask", method: "post", rateLimitMultiplier: 0.25 },
  async (ctx) => {
